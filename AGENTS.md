# java-text-intelligence

Java (Javalin) demo app for Deepgram Text Intelligence.
...
```
feat(java-text-intelligence): add diarization support
fix(java-text-intelligence): resolve WebSocket close handling
refactor(java-text-intelligence): simplify session endpoint
